...
//The slotDef class is not a subclass of MonoBehavior, so it doesnt need
//a seperate C# file.
...
public class Layout : MonoBehaviour {
	public PT_XMLReader			xmlr;	//just like deck, this has PT_XMLReader
	...
	public void ReadLayout(string xmlText) {
		...
		for (int i = 0; i<slotsX.Count; i++) {
			...
			//on top of the others. in unity 2d, all of our assests are
			//effectivly at the same z depth, so the layer is used
